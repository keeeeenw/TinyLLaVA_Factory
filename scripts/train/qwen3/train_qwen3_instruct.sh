...
LLM_VERSION=Qwen/Qwen3-0.6B # llm path in huggingface
...
CONV_VERSION=qwen3_instruct #chat template, other options are: phi, llama, gemmma, etc
VERSION=qwen3-0_5b_base #experiment name for recording different runnings
TRAIN_RECIPE=common #training recipes, other options are: lora, qlora
MODEL_MAX_LENGTH=2048 #max model length for llm

# use tinyllava_factory_gemma3 conda env for training
